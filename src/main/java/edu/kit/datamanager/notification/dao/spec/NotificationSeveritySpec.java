 ...
 * @author jejkal
 */
public class NotificationSeveritySpec{

  private NotificationSeveritySpec(){
  }

  public static Specification<Notification> toSpecification(final Notification.SEVERITY severity){
